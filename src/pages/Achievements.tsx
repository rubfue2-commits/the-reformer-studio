...
const BADGES = [
  ...
  { id: "ten",          icon: Target,     color: "#B8973E", bg: "#FAEEDA", cat: "sessions",
  ...
  { id: "twenty5",      icon: Award,      color: "#B8973E", bg: "#FAEEDA", cat: "sessions",
  ...
  { id: "fifty",        icon: Zap,        color: "#B8973E", bg: "#FAEEDA", cat: "sessions",
  ...
  { id: "hundred",      icon: Trophy,     color: "#B8973E", bg: "#FAEEDA", cat: "sessions",
  ...
  { id: "two_fifty",    icon: Flame,      color: "#B8973E", bg: "#FAEEDA", cat: "sessions",
  ...
  { id: "five_hun",     icon: Crown,      color: "#B8973E", bg: "#FAEEDA", cat: "sessions",
  ...
  // ════════ SÉRIES ══════════════════════════════════════════════
  { id: "streak3",      icon: Flame,      color: "#B8973E", bg: "#FAEEDA", cat: "streak",
  ...
  { id: "streak7",      icon: Flame,      color: "#B8973E", bg: "#FAEEDA", cat: "streak",
  ...
  { id: "streak14",     icon: Flame,      color: "#B8973E", bg: "#FAEEDA", cat: "streak",
  ...
  { id: "streak30",     icon: Crown,      color: "#B8973E", bg: "#FAEEDA", cat: "streak",
  ...
  { id: "streak60",     icon: Sparkles,   color: "#B8973E", bg: "#FAEEDA", cat: "streak",
  ...
  // ════════ BIEN-ÊTRE ═══════════════════════════════════════════
  { id: "wellness1",    icon: Heart,      color: "#B8973E", bg: "#FAEEDA", cat: "wellness",
  ...
  { id: "wellness10",   icon: Smile,      color: "#B8973E", bg: "#FAEEDA", cat: "wellness",
  ...
  { id: "wellness30",   icon: Heart,      color: "#B8973E", bg: "#FAEEDA", cat: "wellness",
  ...
  { id: "measurements",  icon: TrendingUp, color: "#B8973E", bg: "#FAEEDA", cat: "wellness",
  ...
  // ════════ HORAIRES ════════════════════════════════════════════
  { id: "early_bird",   icon: Sun,        color: "#B8973E", bg: "#FAEEDA", cat: "time",
  ...
  { id: "night_owl",    icon: Moon,       color: "#B8973E", bg: "#FAEEDA", cat: "time",
  ...
  { id: "lunch_break",  icon: Coffee,     color: "#7A6020", bg: "#FAEEDA", cat: "time",
  ...
  { id: "weekend_w",    icon: Calendar,   color: "#B8973E", bg: "#FAEEDA", cat: "time",
  ...
  // ════════ VARIÉTÉ ═════════════════════════════════════════════
  { id: "explorer",     icon: Wind,       color: "#B8973E", bg: "#F0F9FF", cat: "variety",
  ...
  { id: "all_rounder",  icon: Dumbbell,   color: "#B8973E", bg: "#FAEEDA", cat: "variety",
  ...
  { id: "program_done", icon: Award,      color: "#B8973E", bg: "#FAEEDA", cat: "variety",
  ...
  { id: "long_session", icon: Zap,        color: "#B8973E", bg: "#FAEEDA", cat: "variety",
  ...
  // ════════ COMMUNAUTÉ ══════════════════════════════════════════
  { id: "first_referral", icon: Sparkles, color: "#B8973E", bg: "#FAEEDA", cat: "social",
  ...
  { id: "reviewer",     icon: Star,       color: "#B8973E", bg: "#FAEEDA", cat: "social",
  ...
  // ════════ SPÉCIAUX ════════════════════════════════════════════
  { id: "comeback",     icon: TrendingUp, color: "#B8973E", bg: "#FAEEDA", cat: "special",
  ...
  { id: "perfect_week", icon: Trophy,     color: "#B8973E", bg: "#FAEEDA", cat: "special",
  ...
  { id: "double_day",   icon: Zap,        color: "#B8973E", bg: "#FAEEDA", cat: "special",
