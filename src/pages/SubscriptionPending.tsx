      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 40 }}>
          <div style={{ position: "relative", width: 32, height: 32 }}>
            <div style={{ position: "absolute", left: 4, top: 2, width: 9, height: 26, borderRadius: 4, backgroundColor: "#1C1B19", transform: "rotate(15deg)" }} />
            <div style={{ position: "absolute", left: 17, top: 4, width: 6, height: 22, borderRadius: 4, backgroundColor: "#B8973E", transform: "rotate(15deg)" }} />
          </div>
          <div style={{ textAlign: "left" }}>
            <p style={{ fontSize: 15, fontWeight: 300, color: "#1C1B19", margin: 0 }}>Connect</p>
            <p style={{ fontSize: 15, fontWeight: 300, color: "#B8973E", margin: 0 }}>Reformer</p>
          </div>
        </div>

        <div style={{ backgroundColor: "white", borderRadius: 20, padding: "36px 24px", boxShadow: "0 4px 32px rgba(0,0,0,0.06)", marginBottom: 16 }}>
          ...
          <p style={{ fontSize: 13, color: "#6B6560", lineHeight: 1.6, margin: "0 0 24px" }}>
          ...
          {[
            ...
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "8px 0", borderBottom: i < 3 ? "1px solid rgba(28,27,25,0.06)" : "none", textAlign: "left" }}>
              <div style={{ width: 28, height: 28, borderRadius: "50%", backgroundColor: s.done ? "#B8973E" : "#E5E0D8", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                {s.done ? <span style={{ color: "white", fontSize: 13 }}>✓</span> : <span style={{ color: "#8B8578", fontSize: 11, fontWeight: 700 }}>{s.step}</span>}
              </div>
          ...
          <button onClick={() => window.open(plan === 'annual' ? "https://buy.stripe.com/test_dRmcMY3Uz91f02hcoN0RG03" : "https://buy.stripe.com/test_14AeV68aPcdrg1f1K90RG02", "_system")}
            style={{ width: "100%", marginTop: 20, padding: "14px", backgroundColor: "#B8973E", color: "#1C1B19", border: "none", borderRadius: 12, fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 10 }}>
            Finaliser mon inscription
            <ExternalLink size={15} />
          </button>

          <button onClick={checkSubscription} disabled={checking}
            style={{ width: "100%", padding: "14px", backgroundColor: "#1C1B19", color: "white", border: "none", borderRadius: 12, fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, opacity: checking ? 0.7 : 1 }}>
