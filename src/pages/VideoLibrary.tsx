...
const filters = ["All", "Toning", "Posture", "Core", "Full Body"];
const durations = ["All", "15 min", "30 min", "45 min"];
      ...
      <div className="px-6 pt-14">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
          ...
          <p className="mt-1 font-body text-sm text-muted-foreground">
            {videos.length} classes available
          </p>
        </motion.div>
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="mt-2 flex items-center gap-2">
                  <span className="rounded-full border border-border px-3 py-0.5 font-body text-[10px] text-muted-foreground">
                    {video.level}
                  </span>
                </div>
              </div>
