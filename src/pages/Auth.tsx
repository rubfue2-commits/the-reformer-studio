      ...
      <div className="relative w-full flex flex-col" style={{
        ...
        <div className="flex flex-col items-center pt-14 pb-8 px-6">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}
            className="mt-3 font-body text-xs tracking-widest uppercase" style={{ color: "#888780" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}
          ...
          className="flex-1 rounded-t-3xl px-6 pt-8 pb-10" style={{ background: "#FFFFFF" }}>
          ...
          <div className="space-y-4">
              ...
              <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }}>
                <div className="flex items-center gap-3 rounded-2xl border px-4 py-3.5"
                  ...
                  <input type="text" placeholder={t.auth.firstName} value={firstName}
                    ...
                    className="flex-1 bg-transparent font-body text-sm outline-none" style={{ color: "#1C1B19" }} />
                </div>
              </motion.div>
            )}
            ...
            <button onClick={handleSubmit}
              className="flex w-full items-center justify-center gap-3 rounded-2xl border py-3.5 font-body text-sm"
